...
makeinstall_target() {
    ...
    ln -sf libMali.so $INSTALL/usr/lib/libGLESv3.so.3.0
    ln -sf libGLESv3.so.3.0 $INSTALL/usr/lib/libGLESv3.so.3
    ln -sf libGLESv3.so.3 $INSTALL/usr/lib/libGLESv3.so
