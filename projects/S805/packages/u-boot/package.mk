...
makeinstall_target() {
  ...
  case $DEVICE in
    ...
    Odroid_C1)
      ...
      if [ -f $PROJECT_DIR/$PROJECT/devices/$DEVICE/bootloader/boot.ini.new ]; then
        cp -PRv $PROJECT_DIR/$PROJECT/devices/$DEVICE/bootloader/boot.ini.new $INSTALL/usr/share/bootloader
      fi
      ;;
    imx6)
