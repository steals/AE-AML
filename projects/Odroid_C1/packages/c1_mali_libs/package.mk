...
PKG_VERSION="cdf9ddb"
PKG_URL="https://github.com/mdrjr/c1_mali_libs/archive/$PKG_VERSION.tar.gz"
#PKG_SOURCE_DIR="opengl-meson-$PKG_VERSION*"
...
makeinstall_target() {
  ...
  mkdir -p $SYSROOT_PREFIX/usr/lib
    cp -PR fbdev/mali_libs/libMali.so $SYSROOT_PREFIX/usr/lib
  ...
  mkdir -p $INSTALL/usr/lib
    cp -PR fbdev/mali_libs/libMali.so $INSTALL/usr/lib
